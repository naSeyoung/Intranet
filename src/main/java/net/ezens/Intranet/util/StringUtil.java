...
public class StringUtil {
	...
	public static String[] getParamValues(HttpServletRequest req, String pname) {
	...
	public static String getParameter(HttpServletRequest req, String pname) {
		...
		String tempValue = req.getParameter(pname);
	...
	public static int getParamInt(HttpServletRequest req, String pname) {
		...
		if ( req.getParameter(pname) == null ) {
			...
			try {
				return Integer.parseInt(req.getParameter(pname));
			}
	...
	public static long getParamLong(HttpServletRequest req, String pname) {
		...
		if ( req.getParameter(pname) == null ) {
			...
			try {
				return Long.parseLong(req.getParameter(pname));
			}
			catch ( NumberFormatException nfex ) {
				return 0;
			}
	...
	public static String urlDecodeUTF8(String inputStr) {
		String decode = "";
		try {
			decode = java.net.URLDecoder.decode(inputStr, "UTF-8");
	...
	public static String urlEncodeUTF8(String inputStr) {
		String encode = "";
		try {
			encode = java.net.URLEncoder.encode(inputStr, "UTF-8");
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
		}
