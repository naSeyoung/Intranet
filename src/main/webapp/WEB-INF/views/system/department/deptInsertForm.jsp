...
function chkIns(){
	if(frm.cpDeptName.value == "" || frm.cpDeptName.value == null){
		alert("부서명을 입력해주세요.");
		frm.cpDeptName.focus();
		return false;
	}
}
					...
					<div class="table-responsive" style="margin-top: 10px;">
						<table class="main-table02">
							...
							<tbody>
								<tr class="dataRow">
									<td style="width: 60%;">
										<input type="hidden" id="cpDeptOrderRank" name="cpDeptOrderRank" class="cpDeptOrderRank" value="1"/> 
										<input type="hidden" id="cpDeptParentSeq" name="cpDeptParentSeq" value="1"/> 
		 								<input type="text" id="cpDeptName" name="cpDeptName" width="90%">
		 							</td>
								</tr>
							</tbody>
						</table>
