                                 ...
                                 <div class="col-sm-12">
                                    <div class="card">
                                       ...
                                       <!-- 파일 표추가 -->
                                             ...
                                             <div>
                                                <a href="/setCalendar"><input type="button"class="main-btn01" value="목록"style="float: right; margin-top: 3%; margin-left: 1%; margin-right: 5%;"></a>
                                                <a href="javascript:submit_calSetForm(document.cal_setform);"><input type="button"class="main-btn01" value="등록"style="float: right; margin-top: 3%; margin-left: 1%; margin"></a>
                                             </div>
                                             </form>
                                          </div>
                                       </div>
