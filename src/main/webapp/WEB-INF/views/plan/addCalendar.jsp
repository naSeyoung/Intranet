...
th {
 ...
 <!--timepicker -->
 <link rel="stylesheet" href="resources/css/fullcalendar/jquery-ui-timepicker-addon.css" />
																...
																<table class="main-table02">
																	<tbody>
																		...
																		<tr>
																			<th>시작일</th>
																			<td>
																				<input type="text" id="cal_start" name = "cal_start" value="" placeholder="날짜선택" style="width: 60%" >
																				<input type="text" id="time1" name="time1" value="" placeholder="시간선택" required size="8" maxlength="5">
																			</td>
																			<th>종료일</th>
																			<td>
																				<input type="text" id="cal_end" name = "cal_end" value="" placeholder="날짜선택" style="width: 60%" >
																				<input type="text" id="time2" name="time2" value="" placeholder="시간선택" required size="8" maxlength="5">
																			</td>
																		</tr>
																		<tr>
																			<th>내용</th>
